//
//  AnimatedCircleWithUniformNoiseView.swift
//  Canvasing
//
...
struct AnimatedCircleWithUniformNoiseView: View {
    ...
    private func generateCirclePath(position: CGPoint, radius: CGFloat, time: Double) -> Path {
        ...
        let noiseGenerator = UniformNoise()
...
#Preview {
    AnimatedCircleWithUniformNoiseView()
}
