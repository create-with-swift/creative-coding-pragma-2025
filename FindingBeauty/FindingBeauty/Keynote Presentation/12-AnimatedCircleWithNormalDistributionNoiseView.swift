//
//  AnimatedCircleWithNormalDistributionNoiseView.swift
//  Canvasing
//
...
struct AnimatedCircleWithNormalDistributionNoiseView: View {
    ...
    private func generateCirclePath(position: CGPoint, radius: CGFloat, time: Double) -> Path {
        ...
        let noiseGenerator = NormalDistributionNoise()
...
#Preview {
    AnimatedCircleWithNormalDistributionNoiseView()
}
